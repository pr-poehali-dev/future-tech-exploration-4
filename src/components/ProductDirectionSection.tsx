    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Поставки и логистика</span>
        ...
        >
          Доставка по всей России — в срок
        </h2>

        {/* Description */}
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Работаем с транспортными компаниями по всей стране.</span> Отслеживайте
          статус заказа в реальном времени — от склада до вашего производства.
        </p>
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              >
                ...
                <span className="text-zinc-300 text-sm font-medium">Заказ #4821 — Двигатели АИР</span>
                <div
              ...
              >
                ...
                <span className="text-zinc-500 text-sm">Комплектация на складе</span>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">В пути — Транссиб</span>
              ...
              >
                <span className="text-zinc-400 text-sm">Доставка получателю</span>
                <div className="flex gap-0.5">
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Полный контроль заказа</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Отслеживайте каждый этап — от оформления заявки до получения на складе.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Заказ #5214</h4>
              ...
              {/* Resources row */}
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-500 text-sm w-20">Позиций</span>
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
                    <span className="text-amber-400">8 наименований</span>
                  </span>
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-400 text-xs">
                    <span className="text-green-500">Всё в наличии</span>
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    ...
                    Принят в работу <span className="text-zinc-500">✓</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-amber-500" />
                    Отгружен со склада <span className="text-zinc-500">✓</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    ...
                    Доставка клиенту <span className="text-zinc-500">3–5 дн</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Статус поставки</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Получайте уведомления об изменении статуса заказа на каждом этапе.
            </p>
            ...
            <div className="relative h-48">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-500 font-medium text-sm">Доставлен</span>
                </div>
                <p className="text-zinc-300 text-sm mb-3">Заказ получен на склад клиента</p>
                <span className="text-zinc-500 text-xs">14 мар</span>
              </div>
            </div>
          </div>
        </div>
