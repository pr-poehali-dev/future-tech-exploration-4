...
const featureCards = [
  {
    title: "Широкий каталог приборов",
    illustration: (
  ...
  {
    title: "Быстрая доставка по России",
    illustration: (
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Мы поставляем электроприборы для предприятий любого масштаба — от небольших мастерских
                до крупных заводов. Раритетная техника, современные модели, гарантийное обслуживание.{" "}
                <a href="#" className="text-white inline-flex items-center gap-1 hover:underline">
                  Смотреть каталог <ChevronRight className="w-4 h-4" />
                </a>
              </p>
            </motion.div>
          </div>
