...
const companies = [
  { name: "МашСтрой", icon: Zap },
  { name: "ПромТех", icon: Hexagon },
  { name: "СтройГрупп", icon: Diamond },
  { name: "ЭнергоПлюс", icon: Star },
  { name: "МеталлПром", icon: Sparkles },
  { name: "АвтоТех", icon: Globe },
  { name: "ТехноПарк", icon: Circle },
  { name: "ИндустриаЛ", icon: Square },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Нам доверяют предприятия по всей стране.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            От малого бизнеса до крупных производственных холдингов.
          </motion.p>
